...
const SignIn = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          const res = await fetch('https://form-sharing-app.vercel.app/api/user/signin', {
            method: 'POST',
            headers: {
          ...
          <div className="w-full bg-white rounded-lg shadow-md dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-slate-50 dark:border-gray-200 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                ...
                <button
                  disabled={loading}
                  className="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-slate-600 hover:bg-slate-700 focus:ring-primary-800"
                >
