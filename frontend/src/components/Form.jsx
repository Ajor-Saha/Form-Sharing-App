  ...
  return (
    <div className="py-5 max-w-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center text-white bg-slate-600 hover:bg-slate-700 focus:ring-primary-800"
        >
          Submit
        </button>
      </form>
